...
pwd
g++ -O3 -Wall -shared -std=c++17 -march=native -fopenmp -fPIC $(python3 -m pybind11 --includes) icp.cpp -o icp$(python3-config --extension-suffix) -I/usr/local/include/eigen3